...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "SalesMoso — The Real Estate Growth Suite" },
      { name: "description", content: "Stop losing six-figure commissions to ghosted leads and dated listings. SalesMoso is the dedicated growth partner for high-performance agents." },
      { name: "author", content: "SalesMoso" },
      ...
      { name: "twitter:site", content: "@SalesMoso" },
    ],
    links: [
